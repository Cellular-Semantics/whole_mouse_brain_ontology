 ...
 * [bdso.yml](bdso.yml)
     * Determines how your purl.obolibrary.org/obo/bdso/ redirects will be handled
     ...
     * Paste in the contents of [bdso.yml](bdso.yml)
 ...
 * [bdso.md](bdso.md)
     ...
     * Paste in the contents of [bdso.md](bdso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
